...
const pool = sql.createPool({ //환경변수 db를 활용하기위함
...
async function query(alias, values = [], where = "") { // query라는 함수만듬 key를넣어주면 쿼리를실행 2번째매개값 value는 사용자등록같은값 3번째 매개값은 추가적인쿼리를 붙일때
